...
(function() {
  var DB_STATE_INIT, DB_STATE_OPEN, READ_ONLY_REGEX, SQLiteFactory, SQLitePlugin, SQLitePluginTransaction, SelfTest, argsArray, connectionMap, dblocations, iosLocationMap, newSQLError, nextTick, root, txLocks;
    ...
    if (this.dbname in this.openDBs) {
      ...
      opensuccesscb = (function(_this) {
        return function(conn) {
          ...
          connectionMap[_this.dbname] = conn;
  ...
  SQLitePluginTransaction.prototype.run = function() {
    ...
    cordova.exec(mycb, null, "SQLitePlugin", "backgroundExecuteSqlBatch", [
      {
        connection: connectionMap[this.db.dbname],
        executes: tropts
      }
    ]);
  };
